...
start "" "%plink_path%" -ssh %remote_user1%@%remote_host1% -pw %remote_password1% "pkill arecord"
start "" "%plink_path%" -ssh %remote_user2%@%remote_host2% -pw %remote_password2% "pkill arecord"
