...
%Display time delays
disp(['Time delay between mics 1 and 2: ', num2str(td56)]);
disp(['Time delay between mics 1 and 3: ', num2str(td57)]);
disp(['Time delay between mics 1 and 4: ', num2str(td58)]);
disp(['Time delay between mics 3 and 4: ', num2str(td78)]);
